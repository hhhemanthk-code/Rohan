    ...
    >
      <div className="relative h-[340px] overflow-hidden rounded-2xl border border-line/40 transition-all duration-500 hover:border-accent/30 hover:shadow-[0_0_40px_rgba(89,255,241,0.08)] sm:h-[380px] lg:h-[420px]">
        <img
          ...
          alt={card.title}
          loading="lazy"
          className="absolute inset-0 h-full w-full object-cover brightness-[0.22] transition-all duration-700 group-hover:scale-105 group-hover:brightness-[0.3]"
        />
        ...
        <div className="absolute inset-0 flex flex-col justify-between p-5 sm:p-6">
          ...
          <div>
            ...
            <p className="mt-3 text-[11px] leading-[1.7] text-white/60 transition-colors duration-400 group-hover:text-white/75 sm:text-[12px] sm:leading-[1.75] lg:text-[13px]">
