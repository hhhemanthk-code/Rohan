...
function LottieIcon({ src, href, label, delay }) {
  ...
  return (
    <motion.a
      ...
      whileTap={{ scale: 0.95 }}
      className="block w-[100px] sm:w-[130px] lg:w-[150px]"
    >
      <div
        ref={containerRef}
        className="h-[100px] w-[100px] sm:h-[130px] sm:w-[130px] lg:h-[150px] lg:w-[150px]"
      />
    </motion.a>
  );
}
    ...
    <footer className="relative z-10 bg-[#050607]">
      ...
      <div className="relative overflow-hidden border-t border-accent/10 py-24 lg:py-32">
        ...
        <div className="relative mx-auto max-w-[1380px] px-6 text-center lg:px-10">
          ...
          <div className="mt-16 flex items-center justify-center gap-14 sm:gap-20 lg:gap-28">
        ...
        <div className="mx-auto max-w-[1380px] px-6 py-14 lg:px-10 lg:py-16">
          <div className="grid gap-10 sm:grid-cols-2 lg:grid-cols-[1.6fr_1fr_1fr_0.8fr]">
            ...
            >
              ...
              <p className="mt-1 text-xs text-white/40 leading-relaxed max-w-[260px]">
                {siteInfo.tagline}
              </p>
              <div className="mt-5 flex gap-3">
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex h-8 w-8 items-center justify-center rounded-full border border-accent/20 bg-accent/[0.05] text-accent transition-all hover:bg-accent/15 hover:shadow-[0_0_14px_rgba(89,255,241,0.2)]"
                >
              ...
              <ul className="space-y-3.5">
                <li>
                  <a
                    ...
                    className="group flex items-center gap-2.5 text-sm text-white/55 transition-colors duration-300 hover:text-accent"
                  >
                    <span className="flex h-6 w-6 items-center justify-center rounded-full bg-accent/[0.08]">
