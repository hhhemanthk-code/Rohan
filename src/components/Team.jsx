              ...
              >
                ...
                >
                  <a
                    ...
                    className="flex h-10 w-10 items-center justify-center rounded-full border border-line bg-panel text-muted transition-all hover:border-accent/30 hover:bg-accent/10 hover:text-accent"
                    aria-label="LinkedIn"
                  >
