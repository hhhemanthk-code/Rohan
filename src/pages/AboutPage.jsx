...
function StoryP({ children, isBold }) {
  const cls = isBold
    ? "text-[15px] leading-[1.85] font-semibold text-white/90 sm:text-base lg:text-[17px]"
    : "text-[15px] leading-[1.85] text-white/60 sm:text-base lg:text-[17px]";
  return (
    <motion.p
    ...
    <div ref={ref} className="relative overflow-hidden py-20 lg:py-28">
      ...
      {bgImage && (
        <motion.div className="absolute inset-0" style={{ y: bgY }}>
          ...
          <div className="absolute inset-0 bg-gradient-to-b from-[#0a0a0a]/70 via-transparent to-[#0a0a0a]/70" />
        </motion.div>
      )}
  ...
  return (
    <div className="site-shell">
      ...
      <main>
          ...
          <div className="mx-auto max-w-[1100px] px-6 lg:px-10">
            ...
            <FadeUp delay={0.18}>
              <span className="mt-4 inline-block text-[11px] font-semibold uppercase tracking-[0.2em] text-white/40">
                Consultant &bull; Builder &bull; Anime nerd &bull; Permanently curious
              </span>
            </FadeUp>
          </div>
        </section>
            ...
            <div className="grid gap-8 lg:grid-cols-[320px_1fr] lg:gap-12 items-start">
              ...
              <FadeUp className="mx-auto w-full max-w-[320px] lg:mx-0">
                ...
                <div className="mt-4 rounded-xl border border-white/[0.06] bg-white/[0.025] p-4 backdrop-blur-sm">
                  <p className="font-heading text-sm font-bold text-white">{siteInfo.name}</p>
        ...
        {/* CHAPTER: The Pivot */}
        <ChapterSection label="The Pivot" bgImage="/images/pivot-chapter-bg.jpg">
          <StoryP>
        ...
        {/* TODAY */}
        <ChapterSection label="Today" bgImage="/images/today-chapter-bg.jpg">
          <StoryP>
        ...
        <section className="relative z-10 py-16 lg:py-24">
          ...
          <div className="mx-auto max-w-[850px] px-6 text-center lg:px-10">
            ...
            <h3 className="font-heading text-xl font-bold leading-[1.6] text-white sm:text-2xl lg:text-3xl">
